...
# cluster_file = '/data2/ossdata/mz/dy_wb_xhs_alignfacefeat_ms1mv3_r50_pred.txt'
# filename_list = '/data2/ossdata/mz/dy_wb_xhs_alignface.txt'
# img_folder = '/data2/ossdata/mz/dy_wb_xhs_faceimgs'
# result_path = '/data2/ossdata/mz/dy_wb_xhs_ms1mv3_r50_pred'

cluster_file = '/data2/ossdata/mz/dy_wb_xhs_alignfacefeat_glint360k_r50_pred.txt'
filename_list = '/data2/ossdata/mz/dy_wb_xhs_alignface.txt'
img_folder = '/data2/ossdata/mz/dy_wb_xhs_faceimgs'
result_path = '/data2/ossdata/mz/dy_wb_xhs_glint360k_r50_pred'
